...
### Come estensione permanente

Pacchettizza l'estensione in un file `.xpi` e installala tramite i componenti aggiuntivi di Firefox. L'estensione richiede i seguenti permessi: tabs, bookmarks, history, activeTab, storage.
